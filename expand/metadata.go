...
Balances.transfer
*/
func (e *MetadataExpand) BalanceTransferCall(to string, amount *big.Int) (types.Call, error) {
	var (
		call types.Call
	)
...
*/
func (e *MetadataExpand) BalanceTransferKeepAliveCall(to string, amount *big.Int) (types.Call, error) {
	var (
		call types.Call
	)
...
*/
func (e *MetadataExpand) UtilityBatchTxCall(toAmount map[string]*big.Int, keepAlive bool) (types.Call, error) {
	var (
		call types.Call
		err  error
	)
...
transfer with memo
*/
func (e *MetadataExpand) UtilityBatchTxWithMemo(to, memo string, amount *big.Int) (types.Call, error) {
	var (
		call types.Call
	)
	btCall, err := e.BalanceTransferCall(to, amount)
